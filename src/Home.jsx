...
const Home = () => {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        const response = await axios.get('http://localhost/plateforme_immo/public/api_generale/get_properties.php');
  ...
  <div className={styles.youAreGrid}>
    ...
    <div className={styles.youAreColumn}>
      ...
      <div className={styles.youAreContent}>
        ...
        <div className={styles.youAreItem}>
          <h4>Vendez/Louez</h4>
          <p>Trouvez rapidement acquéreurs/locataires</p>ccccccccccc
        </div>
      </div>
    </div>
